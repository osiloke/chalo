      ...
      <div className="flex-1 flex flex-col min-w-0 h-screen overflow-y-auto relative">
        ...
        <nav className="glass sticky top-0 z-30 px-6 py-4 flex items-center justify-between border-b-0 m-4 rounded-3xl shadow-lg border-white/40">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-indigo-500 to-rose-500 p-0.5 shadow-lg">
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="flex-1 space-y-8">
              ...
              <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
                 {/* Main Chart Area */}
                 <div className={cn("glass-card border-none min-h-[300px] flex flex-col justify-end p-8 relative overflow-hidden group", currentStep?.id === 'chart-overview' && "border-2 border-indigo-500 shadow-[0_0_20px_rgba(99,102,241,0.3)]")}>
                    ...
                    <div className="flex items-end space-x-2 h-48">
                      {(dataType === 'realtime' 
                        ...
                        <motion.div 
                          ...
                          className={cn("flex-1 bg-gradient-to-t from-indigo-600 to-indigo-400 rounded-lg group-hover:from-indigo-500 group-hover:to-rose-400 transition-colors", i % 2 === 0 && "opacity-80")}
                        />
                      ))}
                    </div>
